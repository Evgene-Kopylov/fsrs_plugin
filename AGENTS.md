...
## `tests/test_script/rebuild-log.sh` - Скрипт пересборки и сбора логов
...
- Уровень логов в тестовом хранилище Verbose, т.е. дебаг уровень видно.
- Если не видно логов, остановиться и сообщить пользователю о проблеме.
