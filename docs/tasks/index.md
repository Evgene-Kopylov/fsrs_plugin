...
- [ ] Описать в AGENTS.md как писать интеграционные тесты. я не хочу видеть sql кусками. тс тест не должен рассуждать где какая часть, а проверять сырое выражение.
