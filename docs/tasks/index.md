...
- [>] [стилизация поля reviews во фронтматтере](reviews-field-styling.md) — скрыть сырой YAML, показать число повторений и цветовые индикаторы
- [x] [вывод записи из повторений](card-retire.md) — поле `fsrs_retired: true`, исключение из расчётов без потери истории
  - [x] этап 1: поле retired, исключение из выборки, интеграционный тест
  - [x] этап 2: команды retire/активация, кнопка disabled
