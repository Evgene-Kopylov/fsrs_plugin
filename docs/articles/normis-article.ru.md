...
Команда вставит готовый блок с SQL-подобным запросом:
...
<!-- ИЛЛЮСТРАЦИЯ 7: Скриншот hover-окна. Курсор наведён на имя файла в строке таблицы — справа появилось окно с содержимым карточки (текст заметки) и кнопками Again/Hard/Good/Easy. Работает без перехода к заметке. -->
